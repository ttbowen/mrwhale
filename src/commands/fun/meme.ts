...
export default class extends Command<BotClient> {
  ...
  async action(message: Message, [memeName, top, bottom]: [string, string, string]): Promise<any> {
    ...
    return request.post('https://api.imgflip.com/caption_image', { form: data }).then(response => {
